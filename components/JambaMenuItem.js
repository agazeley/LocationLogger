    ...
    render(){
        return(
            <View style={styles.SubMenuItemContainer}>
                <View>
                    <Text style={styles.headerText}>JAMBA</Text>
                </View>
                <View style={{marginLeft: 20, flex: .5}}>
                    <Text style={styles.SubMenuItemText}>Purchase a delicious Jamba Juice drink to go with your food!</Text>
                </View>   
                <View style={{marginLeft:20, flex: .25, paddingTop: 50}}>
                    <Button
                        icon={{name: 'code'}}
