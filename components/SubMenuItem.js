        ...
        return(
            <View style={styles.SubMenuItemContainer}>
                ...
                <View style={{marginLeft: 20, flex: .5}}>
                    <Text style={styles.SubMenuItemText}>Pick from our signature subs or customize your own!</Text>
                </View>   
                <View style={{marginLeft:20, flex: .25,}}>
                    <Button
                        ...
                        onPress={ () => navigate('Subs', {cart: this.props.cart, user: this.props.user}) }
                    />
                </View>
            </View>
        )
